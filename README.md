...
- 27 млн. активных пользователей в месяц;
- Преимущественно в возрасте от 25 до 44 лет;
- Доходом выше средний или выше среднего;
- Имеют личный автомобиль.

Исходя из этих данных возьмём MAU для нашего сервиса порядка 24 млн, учитывая, что не все пользователи имеют личный автомобиль.
...
Использую GeoDNS определяется физически ближайший к пользователю ЦОД. 
...
### Источники:
1. [MAU геосервисов Яндекс](https://yandex.ru/adv/products/geo/navigator-traffic)
2. [Анализ аудитории геосервисов Яндекс](https://yandex.ru/adv/solutions/analytics/auditoriya-geoservisov-kto-polzuetsya-onlajn-kartami-i-navigaciej)
3. [Информация о приросте аудитории Яндекс Карт](https://mindbox.ru/journal/experts/it-brand/)
4. [Информация о платных парковках](https://gorparkovki.ru/)
