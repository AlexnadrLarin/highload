...
- Таблица **favourites**: Для хранения информации о избранных парковках пользователя также можно использовать реляционную базу данных, поддерживающую быстрый доступ к данным, такой как PostgreSQL. Для повышения производительности будем использовать Redis(user_id) для хранения популярных избранных парковок или информации о последних избранных парковках пользователя.
...
### Физическая схема
![image](https://github.com/AlexnadrLarin/highload/assets/47739783/92049c7b-1303-4c2a-8a69-e00a4cdeeb41)
